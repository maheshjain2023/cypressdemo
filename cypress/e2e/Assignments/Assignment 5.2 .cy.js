describe('Window Handling And Iframes',()=>{
  ...
  cy.xpath('//div[@class="single_tab_div resp-tab-content resp-tab-content-active"]/a')
        .invoke('removeAttr','target').click()   //clicking on link
  
  cy.url().should('include','https://www.globalsqa.com/demo-site/') 
